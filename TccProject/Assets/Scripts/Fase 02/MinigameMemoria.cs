...
IEnumerator FadeFinal()
{
    ...
    imagemCompletaGroup.gameObject.SetActive(true); // Garante que est� ativa

    // Fade das pe�as e da imagem final
    while (tempo < duracao)
    {
    ...
    // Troca de cena
    SceneManager.LoadScene("MapFase3"); // ou o nome da pr�xima cena
}
}
